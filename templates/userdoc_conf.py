...
inheritance_modules = [
    # Add here modules that you want to include in the manual
    'trytond_doc',
    'party',
#'product',
#'product_price_list',
...
if 'sphinxcontrib.trydoc' in extensions:
    ...
    proteus_config = proteus.config.set_trytond(database_name='trydoc_party',
            database_type='postgresql', language='es_ES', password='admin',
            config_file='/home/guillem/nan/projectes/virtualenv/nan-tryton/trytond/etc/trytond.conf')
    #all_modules = proteus.Model.get('ir.module.module').find([])
    trydoc_modules = inheritance_modules
